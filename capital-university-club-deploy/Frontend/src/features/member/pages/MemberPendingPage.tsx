...
export default function MemberPendingPage() {
    ...
    return (
        ...
        >
            ...
            >
                <img src={hucLogo} alt="نادي جامعة العاصمة" className="h-16 w-16 rounded-full object-cover shadow border-2 border-white" />
                <p className="text-gray-400 text-sm font-medium tracking-wide">نادي جامعة العاصمة</p>
            </motion.div>
            ...
            >
                ...
                <div className="p-8 flex flex-col items-center text-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm">مرحباً بك في نادي جامعة العاصمة</p>
                    </div>
