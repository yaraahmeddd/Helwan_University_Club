...
import { type RegisterFormValues } from '@/features/registration/schemas/validation';
import { useRegisterSchema } from '@/hooks/useValidation';
import { prepareSubmissionData, debugFormData, type FileUploadMap } from '@/features/registration/utils/submissionFactory';
import { AuthService } from '@/services/authService';
import { RegisterStepIndicator } from '@/features/registration/components/RegisterStepIndicator';
import { StaffRegisterWizardSteps } from '@/features/registration/components/StaffRegisterWizardSteps';
import {
    STAFF_WIZARD_STEP_FIELDS,
    getNextStaffWizardStep,
    getPrevStaffWizardStep,
} from '@/features/registration/registerWizardConfig';
