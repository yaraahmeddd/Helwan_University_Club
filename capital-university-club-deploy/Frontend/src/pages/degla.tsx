...
const App = () => {
    ...
    const newsItems = [
        { id: 1, category: "كرة قدم", title: "نادي جامعة العاصمة يتعاقد مع نجوم جدد", date: "20 نوفمبر", image: "/api/placeholder/400/300" },
    ...
    const SectionTitle = ({ title, subtitle, centered = true }) => (
        <div className={`mb-16 ${centered ? "text-center" : "text-right"}`}>
            <span className="text-[#ff9900] font-bold tracking-wider uppercase text-sm">نادي جامعة العاصمة</span>
                            ...
                            <div className="container mx-auto px-6 relative z-10 pt-20">
                                <div className="max-w-3xl text-white text-right">
                                    <div className="inline-block bg-[#ff9900] text-white font-bold px-4 py-1 rounded-full mb-6 text-sm shadow-lg">
                                        مرحباً بك في نادي جامعة العاصمة
                                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        >
                            ...
                            <div className="hidden md:block">
                                <h1 className="font-extrabold text-lg text-[#0e1c38] leading-tight">نادي جامعة العاصمة</h1>
            ...
            <footer className="bg-[#0e1c38] text-white pt-20 pb-10 rounded-t-[3rem] mt-10">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
                        ...
                        <div className="max-w-sm">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="font-bold text-2xl">نادي جامعة العاصمة</h3>
                    ...
                    <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-gray-500 text-sm">© {new Date().getFullYear()} نادي جامعة العاصمة — جميع الحقوق محفوظة</p>
