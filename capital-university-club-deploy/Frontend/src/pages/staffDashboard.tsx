...
// and each sub-page is fetched only when the user navigates to it.
const DashboardPage = lazy(() => import("./DashboardPage"));
const SportsPage = lazy(() => import("./SportsPage"));
const MembershipsPage = lazy(() => import("./MemberShipsPage"));
const RegistrationManagementPage = lazy(() => import("./RegistrationManagementPage"));
// const MembershipFormPage = lazy(() => import("./MembershipFormPage"));
// const FinancePage = lazy(() => import("./FinancePage"));
// const TaskApprovalPage = lazy(() => import("./TaskApprovalPage"));
const AdminPrivilegesPage = lazy(() => import("./AdminPrivilegesPage"));
const NotFound = lazy(() => import("./NotFound"));
const AuditLogPage = lazy(() => import("./AuditLogPage"));
const MediaManagerPage = lazy(() => import("./MediaManagerPage"));
const AddNewStaffPage = lazy(() => import("./AddNewStaffPage"));
const StaffListPage = lazy(() => import("./StaffListPage"));
const StaffManagementPage = lazy(() => import("./StaffManagementPage"));
const StaffProfile = lazy(() => import("./StaffProfile"));
const PrivilegePackageAdminPage = lazy(() => import("./PrivilegePackageAdminPage"));
const PackageManagementPage = lazy(() => import("./PackageManagementPage"));
const AssignStaffPrivilegesPage = lazy(() => import("./AssignStaffPrivilegesPage"));
const RevokePrivilegesPage = lazy(() => import("./RevokePrivilegesPage"));
const MemberManagementPage = lazy(() => import("./MemberManagementPage"));
const StaffAddMemberPage = lazy(() => import("./StaffAddMemberPage"));
const StaffAddTeamMemberPage = lazy(() => import("./StaffAddTeamMemberPage"));
const SportsMembersPage = lazy(() => import("./SportsMembersPage"));
const SportManagementPage = lazy(() => import("./SportManagementPage"));
// const SportsRequestsPage = lazy(() => import("./SportsRequestsPage"));
const CourtsManagementPage = lazy(() => import("./CourtsManagementPage"));
const CourtBookingsPage = lazy(() => import("./CourtBookingsPage"));
// const AttendancePage = lazy(() => import("./AttendancePage"));
const TeamsManagementPage = lazy(() => import("./TeamsManagementPage"));
const SubscriptionsPage = lazy(() => import("./SubscriptionsPage"));
const CardPrintPage = lazy(() => import("./CardPrintPage"));
const ManageInvitationsPage = lazy(() => import("./ManageInvitationsPage"));
const FacultyManagementPage = lazy(() => import("./FacultyManagementPage"));
const BranchManagementPage = lazy(() => import("./BranchManagementPage"));
const ProfessionManagementPage = lazy(() => import("./ProfessionManagementPage"));
