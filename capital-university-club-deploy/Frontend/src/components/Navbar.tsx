...
const navTabs = [
  ...
  { key: "Sports", label: "الألعاب الرياضية" },
  { key: "memberships", label: "العضويات" },
  { key: "lastNews", label: "آخر الأخبار" },
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className={`${isDark ? "bg-[#f8941c]" : "bg-gradient-to-br from-blue-50 to-white border border-gray-100"} p-2 rounded-xl shadow-${isDark ? "lg" : "sm"}`}>
                <img src={HUCLogo} alt="نادي جامعة العاصمة" className="w-12 h-12 object-contain" />
              </div>
              <div className="hidden md:block">
                <h1 className={`font-extrabold text-lg ${isDark ? "text-white" : logoClasses} leading-tight`}>نادي جامعة العاصمة</h1>
                {isDark && <p className="text-[#a0d5e8] text-xs font-bold">نادي جامعة العاصمة</p>}
              </div>
            </div>
