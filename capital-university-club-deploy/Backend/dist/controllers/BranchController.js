...
class BranchController {
    ...
    static async createBranch(req, res) {
        try {
            ...
            const newBranch = new Branch_1.Branch();
            newBranch.code = code;
    ...
    static async updateBranch(req, res) {
        try {
            ...
            if (location_en !== undefined)
                branch.location_en = location_en;
            if (location_ar !== undefined)
                branch.location_ar = location_ar;
            if (phone !== undefined)
                branch.phone = phone;
            if (status !== undefined)
    ...
    static async deleteBranch(req, res) {
        try {
            ...
            try {
                const branchSportTeamRepo = data_source_1.AppDataSource.getRepository('BranchSportTeam');
     ...
     */
    static async assignBranchToMember(req, res) {
        try {
...
BranchController.branchRepo = data_source_1.AppDataSource.getRepository(Branch_1.Branch);
