...
exports.DetailedRegistrationController = void 0;
const DetailedRegistrationService_1 = require("../services/DetailedRegistrationService");
const localFileStorage_1 = require("../utils/localFileStorage");
const detailedService = new DetailedRegistrationService_1.DetailedRegistrationService();
...
class DetailedRegistrationController {
    /**
     ...
     */
    static async getVisitorMembershipTypes(req, res) {
        try {
     ...
     */
    static async getEmploymentStatusOptions(req, res) {
        try {
            const statuses = [
                {
                    code: 'employed',
     ...
     * }
     */
    static async submitVisitorDetails(req, res) {
        try {
            const { member_id, job_title_en, job_title_ar, employment_status, visitor_type, branch_id } = req.body;
     ...
     * }
     */
    static async submitWorkingDetails(req, res) {
        try {
            const { member_id, profession_id, department_en, department_ar, salary, employment_start_date, } = req.body;
            // Validate required fields
            ...
            try {
                ...
                if (salarSlipFile) {
                    salary_slip = await (0, localFileStorage_1.saveToLocalStorage)(salarSlipFile.buffer, salarSlipFile.originalname, localFileStorage_1.DocumentType.SALARY_SLIP, localFileStorage_1.UserType.MEMBER);
                }
            }
            catch (uploadError) {
                console.error('File upload error:', uploadError);
     ...
     * }
     */
    static async submitRetiredDetails(req, res) {
        try {
            const { member_id, former_department_en, former_department_ar, retirement_date } = req.body;
            // Validate required fields
     ...
     * }
     */
    static async submitStudentDetails(req, res) {
        try {
     ...
     */
    static async getMemberStatus(req, res) {
        try {
...
exports.DetailedRegistrationController = DetailedRegistrationController;
exports.default = DetailedRegistrationController;
//# sourceMappingURL=DetailedRegistrationController.js.map