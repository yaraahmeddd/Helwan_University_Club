...
class FacultyController {
    ...
    static async createFaculty(req, res) {
        try {
            ...
            const newFaculty = new Faculty_1.Faculty();
     ...
     */
    static async assignFacultyToMember(req, res) {
        try {
            ...
            const universityStudentDetail = await data_source_1.AppDataSource.getRepository('UniversityStudentDetail').findOne({
                where: { member_id: mId },
            });
            ...
            await data_source_1.AppDataSource.getRepository('UniversityStudentDetail').save(universityStudentDetail);
...
FacultyController.facultyRepo = data_source_1.AppDataSource.getRepository(Faculty_1.Faculty);
