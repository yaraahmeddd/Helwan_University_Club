...
exports.TeamMemberBookingController = void 0;
const BookingService_1 = require("../services/BookingService");
const FieldService_1 = require("../services/FieldService");
const data_source_1 = require("../database/data-source");
class TeamMemberBookingController {
    constructor() {
     ...
     */
    async getBookableSports(req, res) {
        try {
     ...
     */
    async getBookableFieldsBySport(req, res) {
        try {
     ...
     */
    async getFieldCalendar(req, res) {
        try {
     ...
     */
    async createTeamMemberBooking(req, res) {
        try {
     ...
     */
    async getTeamMemberBookings(req, res) {
        try {
    ...
    async getUpcomingBookings(req, res) {
        try {
            ...
            const upcomingBookings = allBookings.filter(booking => new Date(booking.start_time) > now &&
    ...
    async getBookingHistory(req, res) {
        try {
            ...
            const historyBookings = allBookings.filter(booking => new Date(booking.start_time) <= now ||
...
exports.TeamMemberBookingController = TeamMemberBookingController;
//# sourceMappingURL=TeamMemberBookingController.js.map