...
class AnnouncementController {
    constructor() {
         ...
         * Admin only
         */
        this.createAnnouncement = async (req, res) => {
            try {
                const user = req.user;
                ...
                const { sport_id, branch_id, title_en, title_ar, description_en, description_ar, banner_image, thumbnail_image, external_link, target_role, min_age, max_age, priority, expires_at, } = req.body;
                // Validation
         ...
         */
        this.getAnnouncementById = async (req, res) => {
            try {
         ...
         */
        this.getAllAnnouncements = async (req, res) => {
            try {
         ...
         */
        this.getPublicAnnouncements = async (req, res) => {
            try {
         ...
         */
        this.getAnnouncementsBySport = async (req, res) => {
            try {
                ...
                const announcements = await this.announcementService.getAnnouncementsBySport(Number(sportId), true // published only
                );
                res.json({
                    success: true,
                    count: announcements.length,
         ...
         * Admin only
         */
        this.updateAnnouncement = async (req, res) => {
            try {
                const { announcementId } = req.params;
                if (!announcementId) {
                    res.status(400).json({
                ...
                const announcement = await this.announcementService.updateAnnouncement(Number(announcementId), req.body);
                if (!announcement) {
                    res.status(404).json({
                        success: false,
                        message: 'Announcement not found',
         ...
         * Admin only
         */
        this.publishAnnouncement = async (req, res) => {
            try {
                const { announcementId } = req.params;
                if (!announcementId) {
                    res.status(400).json({
         ...
         * Admin only
         */
        this.archiveAnnouncement = async (req, res) => {
            try {
                const { announcementId } = req.params;
                if (!announcementId) {
                    res.status(400).json({
         ...
         * Admin only
         */
        this.deleteAnnouncement = async (req, res) => {
            try {
                const { announcementId } = req.params;
                if (!announcementId) {
                    res.status(400).json({
         ...
         */
        this.recordClick = async (req, res) => {
            try {
                const { announcementId } = req.params;
                if (!announcementId) {
                    res.status(400).json({
         ...
         */
        this.getTrendingAnnouncements = async (req, res) => {
            try {
                const { limit } = req.query;
                const announcements = await this.announcementService.getTrendingAnnouncements(limit ? Number(limit) : 5);
                res.json({
                    success: true,
                    count: announcements.length,
                    data: announcements,
