...
exports.WorkingMemberController = void 0;
const WorkingMemberService_1 = require("../services/WorkingMemberService");
const workingService = new WorkingMemberService_1.WorkingMemberService();
class WorkingMemberController {
    /**
    ...
    static async calculateMembershipPrice(req, res) {
        try {
            const { profession_id, salary, is_related_to_active_member, related_member_id, } = req.body;
     ...
     */
    static async submitWorkingMemberDetails(req, res) {
        try {
            const { member_id, profession_id, department_en, department_ar, salary, employment_start_date, is_related_to_active_member, related_member_id, relationship_type, } = req.body;
     ...
     */
    static async createWorkingMembership(req, res) {
        try {
            const { member_id, profession_id, salary, is_related_to_active_member, related_member_id, } = req.body;
     ...
     */
    static async getWorkingMemberStatus(req, res) {
        try {
...
exports.WorkingMemberController = WorkingMemberController;
exports.default = WorkingMemberController;
//# sourceMappingURL=WorkingMemberController.js.map