...
exports.TeamTrainingScheduleController = void 0;
const TeamTrainingScheduleService_1 = require("../services/TeamTrainingScheduleService");
// DayOfWeek removed as it's not exported.
class TeamTrainingScheduleController {
    constructor() {
        this.scheduleService = new TeamTrainingScheduleService_1.TeamTrainingScheduleService();
    }
    /**
     ...
     */
    async getTeamSchedules(req, res) {
        try {
            const { teamId } = req.params;
     ...
     */
    async getSportSchedules(req, res) {
        try {
...
exports.TeamTrainingScheduleController = TeamTrainingScheduleController;
//# sourceMappingURL=TeamTrainingScheduleController.js.map