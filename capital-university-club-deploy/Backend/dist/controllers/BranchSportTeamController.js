...
exports.BranchSportTeamController = void 0;
 ...
 */
class BranchSportTeamController {
    constructor() {
        /**
        ...
        this.createTeam = async (req, res) => {
            try {
                ...
                const { branch_id, sport_id, name_en, name_ar, max_participants, } = req.body;
                // Validation
         ...
         */
        this.getAllTeams = async (req, res) => {
            try {
         ...
         */
        this.getTeamsByBranchAndSport = async (req, res) => {
            try {
         ...
         */
        this.getAvailableTeams = async (req, res) => {
            try {
         ...
         * Admin only
         */
        this.approveTeam = async (req, res) => {
            try {
                const { teamId } = req.params;
                const user = req.user;
                if (!user || !user.staff_id) {
         ...
         * Admin only
         */
        this.declineTeam = async (req, res) => {
            try {
                const { teamId } = req.params;
                const user = req.user;
                if (!user || !user.staff_id) {
         ...
         * Admin only
         */
        this.archiveTeam = async (req, res) => {
            try {
                const { teamId } = req.params;
                if (!teamId) {
                    res.status(400).json({
...
exports.BranchSportTeamController = BranchSportTeamController;
//# sourceMappingURL=BranchSportTeamController.js.map