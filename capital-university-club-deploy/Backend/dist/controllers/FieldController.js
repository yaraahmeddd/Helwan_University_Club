...
class FieldController {
    ...
    static async createField(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
            const data = req.body;
            // Validation
     ...
     */
    static async addOperatingHours(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
            const { id } = req.params;
     ...
     */
    static async getOperatingHours(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
            const { id } = req.params;
     ...
     */
    static async deleteOperatingHours(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
     ...
     */
    static async getFieldsByBranch(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
     ...
     */
    static async updateBookingSettings(req, res) {
        try {
            const { id } = req.params;
     ...
     */
    static async getBookableFields(req, res) {
        try {
            const { sport_id } = req.query;
            const fieldService = new FieldService_1.FieldService();
            const fields = await fieldService.getBookableFields(sport_id ? Number(sport_id) : undefined);
            res.status(200).json({
                success: true,
     ...
     */
    static async getBookableFieldsBySport(req, res) {
        try {
            const fieldService = new FieldService_1.FieldService();
