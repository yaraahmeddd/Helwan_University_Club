...
exports.RetiredMemberService = void 0;
...
class RetiredMemberService {
     ...
     */
    static calculateSalaryBasedPrice(professionCode, salary) {
        ...
        if (salary > 10000)
            return { price: 10000, tier: 'high' };
        if (salary >= 8000)
            return { price: 8000, tier: 'upper_mid' };
        if (salary >= 5000)
            return { price: 5000, tier: 'mid' };
    ...
    static async submitRetiredMemberDetails(retiredData) {
        const retiredRepository = (0, typeorm_1.getRepository)(RetiredEmployeeDetail_1.RetiredEmployeeDetail);
     ...
     */
    static async getRetiredMemberStatus(member_id) {
        const memberRepository = (0, typeorm_1.getRepository)(Member_1.Member);
        const retiredRepository = (0, typeorm_1.getRepository)(RetiredEmployeeDetail_1.RetiredEmployeeDetail);
        const relationshipRepository = (0, typeorm_1.getRepository)(MemberRelationship_1.MemberRelationship);
...
exports.RetiredMemberService = RetiredMemberService;
//# sourceMappingURL=RetiredMemberService.js.map