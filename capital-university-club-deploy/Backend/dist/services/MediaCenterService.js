...
exports.MediaCenterService = void 0;
const data_source_1 = require("../database/data-source");
const Advertisement_1 = require("../entities/Advertisement");
const AdvertisementPhoto_1 = require("../entities/AdvertisementPhoto");
const AdvertisementCategory_1 = require("../entities/AdvertisementCategory");
class MediaCenterService {
    constructor() {
        this.advertisementRepository = data_source_1.AppDataSource.getRepository(Advertisement_1.Advertisement);
        this.photoRepository = data_source_1.AppDataSource.getRepository(AdvertisementPhoto_1.AdvertisementPhoto);
        this.categoryRepository = data_source_1.AppDataSource.getRepository(AdvertisementCategory_1.AdvertisementCategory);
    }
    /**
     ...
     */
    async createAdvertisement(data, staffId, staffTypeId, photos) {
     ...
     */
    async approveAdvertisement(id, managerId, approvalNotes) {
     ...
     */
    async rejectAdvertisement(id, managerId, rejectionReason) {
        const ad = await this.advertisementRepository.findOne({ where: { id } });
        if (!ad) {
            throw new Error('Advertisement not found');
        }
...
exports.MediaCenterService = MediaCenterService;
exports.default = MediaCenterService;
//# sourceMappingURL=MediaCenterService.js.map