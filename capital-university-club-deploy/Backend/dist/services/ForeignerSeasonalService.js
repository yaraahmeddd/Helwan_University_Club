...
exports.ForeignerSeasonalService = void 0;
 ...
 */
class ForeignerSeasonalService {
    constructor() {
    ...
    async submitForeignerSeasonalDetailedInfo(memberData) {
        ...
        if (!memberData.passport_photo)
            missingFiles.push('passport_photo');
        ...
        if (memberData.passport_photo)
            updateData.national_id_front = memberData.passport_photo; // Store passport as national_id_front for foreigners
        if (memberData.medical_report)
     ...
     */
    async getMembershipPricingDetails(duration_months) {
        const durations = {
     ...
     */
    async getForeignerMemberStatus(memberId) {
...
exports.ForeignerSeasonalService = ForeignerSeasonalService;
exports.default = new ForeignerSeasonalService();
//# sourceMappingURL=ForeignerSeasonalService.js.map