...
exports.createLocalizedError = createLocalizedError;
const messages = {
 ...
 */
function createLocalizedResponse(success, messageKey, language = 'en', data) {
    return {
        success,
 ...
 */
function createLocalizedError(messageKey, language = 'en', error) {
    return {
        success: false,
        message: getMessage(messageKey, language),
