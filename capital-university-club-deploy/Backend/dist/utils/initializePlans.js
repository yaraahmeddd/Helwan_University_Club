...
exports.initializeDefaultPlans = initializeDefaultPlans;
/**
...
async function initializeDefaultPlans() {
    try {
        const planRepository = data_source_1.AppDataSource.getRepository(MembershipPlan_1.MembershipPlan);
        const memberTypeRepository = data_source_1.AppDataSource.getRepository(MemberType_1.MemberType);
        ...
        for (const planData of defaultPlans) {
            ...
            if (!existing) {
                ...
                const memberTypeCode = planMemberTypeMap[planData.plan_code];
...
//# sourceMappingURL=initializePlans.js.map