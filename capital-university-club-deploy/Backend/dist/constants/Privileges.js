...
exports.PRIVILEGES_SUMMARY = exports.PRIVILEGE_CODES = exports.PRIVILEGES = void 0;
exports.getPrivilegesByModule = getPrivilegesByModule;
 ...
 */
exports.PRIVILEGE_CODES = Object.keys(exports.PRIVILEGES);
/**
 * Get all privileges grouped by module
 * Useful for displaying privileges organized by category
 */
function getPrivilegesByModule(module) {
    if (!module) {
        return exports.PRIVILEGES;
    }
    return Object.fromEntries(Object.entries(exports.PRIVILEGES).filter(([_, priv]) => priv.module === module));
}
/**
 * Get a single privilege by code
 */
function getPrivilege(code) {
    return exports.PRIVILEGES[code];
}
/**
 * Check if a privilege exists
 */
function hasPrivilege(code) {
    return code in exports.PRIVILEGES;
}
/**
...
function getAllModules() {
    ...
    Object.values(exports.PRIVILEGES).forEach((priv) => {
 ...
 */
exports.PRIVILEGES_SUMMARY = {
    total_privileges: exports.PRIVILEGE_CODES.length,
    modules: getAllModules(),
    modules_count: getAllModules().length,
    by_module: Object.fromEntries(getAllModules().map((module) => [
        module,
        Object.values(exports.PRIVILEGES).filter((p) => p.module === module).length,
    ])),
};
