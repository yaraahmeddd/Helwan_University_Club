...
router.post('/start', auth_1.authenticate, (req, res) => controller.start(req, res));
router.get('/status/:paymentReference', auth_1.authenticate, (req, res) => controller.status(req, res));
