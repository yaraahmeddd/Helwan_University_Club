 ...
 */
router.get('/public/list', (req, res) => FacultyController_1.default.getAllFaculties(req, res));
/**
 ...
 * }
 */
router.get('/', (0, authorizePrivilege_1.authorizePrivilege)('VIEW_FACULTIES'), (req, res) => FacultyController_1.default.getAllFaculties(req, res));
/**
 ...
 * }
 */
router.get('/:id', (0, authorizePrivilege_1.authorizePrivilege)('VIEW_FACULTIES'), (req, res) => FacultyController_1.default.getFacultyById(req, res));
/**
 * POST /api/faculties
 * Create new faculty
 ...
 * }
 */
router.post('/', (0, authorizePrivilege_1.authorizePrivilege)('CREATE_FACULTY'), (req, res) => FacultyController_1.default.createFaculty(req, res));
/**
 ...
 * }
 */
router.put('/:id', (0, authorizePrivilege_1.authorizePrivilege)('UPDATE_FACULTY'), (req, res) => FacultyController_1.default.updateFaculty(req, res));
/**
 ...
 * }
 */
router.delete('/:id', (0, authorizePrivilege_1.authorizePrivilege)('DELETE_FACULTY'), (req, res) => FacultyController_1.default.deleteFaculty(req, res));
/**
 ...
 * }
 */
router.post('/:facultyId/assign-to-member/:memberId', (0, authorizePrivilege_1.authorizePrivilege)('ASSIGN_FACULTY_TO_MEMBER'), (req, res) => FacultyController_1.default.assignFacultyToMember(req, res));
