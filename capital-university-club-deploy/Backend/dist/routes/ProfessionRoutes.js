 ...
 * }
 */
router.get('/', (0, authorizePrivilege_1.authorizePrivilege)('VIEW_PROFESSIONS'), (req, res) => ProfessionController_1.default.getAllProfessions(req, res));
/**
 ...
 * }
 */
router.get('/:id', (0, authorizePrivilege_1.authorizePrivilege)('VIEW_PROFESSIONS'), (req, res) => ProfessionController_1.default.getProfessionById(req, res));
/**
 ...
 * }
 */
router.post('/', (0, authorizePrivilege_1.authorizePrivilege)('CREATE_PROFESSION'), (req, res) => ProfessionController_1.default.createProfession(req, res));
/**
 ...
 * }
 */
router.put('/:id', (0, authorizePrivilege_1.authorizePrivilege)('UPDATE_PROFESSION'), (req, res) => ProfessionController_1.default.updateProfession(req, res));
/**
 ...
 * }
 */
router.delete('/:id', (0, authorizePrivilege_1.authorizePrivilege)('DELETE_PROFESSION'), (req, res) => ProfessionController_1.default.deleteProfession(req, res));
/**
 ...
 * }
 */
router.post('/:professionId/assign-to-member/:memberId', (0, authorizePrivilege_1.authorizePrivilege)('ASSIGN_PROFESSION_TO_MEMBER'), (req, res) => ProfessionController_1.default.assignProfessionToMember(req, res));
